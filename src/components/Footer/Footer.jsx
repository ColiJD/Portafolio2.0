...
const Footer = () => {
  return (
    <Container sx={MuiConta} component="footer">
      <Typography variant="h4" color="in">
        Desarrollado por ColindresJD
      </Typography>
      <Box sx={{ paddingTop: "1.2rem" }}>
        ...
        <MuiButton
          ...
          onClick={() => {
            window.open(
              "https://api.whatsapp.com/send?phone=+50488716380&text=Hola%21%20Quisiera%20chatear%20con%20usted."
            );
          }}
          endIcon={
            <svg
